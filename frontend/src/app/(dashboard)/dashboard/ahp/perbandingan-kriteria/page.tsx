                                    ...
                                    <Table className="min-w-max border-collapse">
                                       ...
                                       <TableBody>
                                                   ...
                                                   return (
                                                      <TableCell key={kolom.kode} className={`p-2 border text-center transition-colors ${isDiagonal ? 'bg-slate-50/50' : isErrorCell ? 'bg-red-100/80 border-red-300' : isSegitigaBawah ? 'bg-slate-50/50' : ''}`}>
                                                         {isDiagonal ? (
                                                            ...
                                                            // PERBAIKAN: Menggunakan parseFloat agar angka '3.000' menjadi '3', tetapi '0.333' tetap tampil utuh
                                          ...
                                          <TableRow className="bg-slate-100">
                                             ...
                                             {kriteria.map((kolom) => (
                                                // PERBAIKAN: Baris jumlah juga dibersihkan dengan parseFloat
                                             ...
                                             {kriteria.map((kolom) => {
                                                ...
                                                return (
                                                   <TableCell key={kolom.kode} className="text-center border text-slate-500 font-mono leading-tight align-middle">
                                                      <div className="font-bold text-slate-700 text-[12px]">{parseFloat(valAwal.toFixed(3))}</div>
